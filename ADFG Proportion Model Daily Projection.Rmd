...
This projection was generated using the model version PSSprop_ESprop, which relies on fitting a single logistic curve to previous years (2005 - 2022) complete cumulative Pilot Station Sonar Chinook salmon passage to estimate the mean cumulative proportion expected on each day of the season. This proportion is used to generate a mid-season expectation of the season total Pilot Station Sonar passage to estimate of the Canadian-origin Chinook salmon run size. Additionally, Eagle Sonar observed Chinook salmon passage is used in this model beginning when Chinook salmon arrive at the site.
