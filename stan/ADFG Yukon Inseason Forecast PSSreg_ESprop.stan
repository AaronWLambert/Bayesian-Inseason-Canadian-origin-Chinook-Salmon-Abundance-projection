// Yukon King Inseason Forecast version PSSreg_ESprop
//Notes: Eagle simple proportion estimator 
     

//Components:
//  1) Pre-season forecast  (Prior)
//  2) EOS-Can ~ PSS in normal space
//  3) Eagle Sonar regression added to likelihood when they are observed in current year
//  
...
transformed parameters{
  ...
  // Current yeras PSS prediction
  real curr_predPSS;
  
  // Cumulative Eagle counts
  real cum_current_Eagle;
  
  // Current years predicted Eagle
  real curr_predEagle;
  ...
  // Current year predicted PSS passage
